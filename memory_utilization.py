...
fh = open('/Users/vinayreddy/Desktop/logs/gregory-server-performance/tmp8AqQtA/PolicyManagerLogs/system-load-monitor/ram.csv', 'w')

outputwriter = csv.writer(fh)

fh2 = open('/Users/vinayreddy/Desktop/logs/gregory-server-performance/tmp8AqQtA/PolicyManagerLogs/system-load-monitor/swap.csv', 'w')
...
pandas_plot = pd.read_csv('/Users/vinayreddy/Desktop/logs/gregory-server-performance/tmp8AqQtA/PolicyManagerLogs/system-load-monitor/ram.csv', names=columns, header=None)
