...
with open('/Users/vinayreddy/Desktop/logs/jeff_social_login/latest_logs/tmpZCO9pl/PolicyManagerLogs/samba/samba_CAMPUS/log.wb-CAMPUS', 'r') as fh:
    for line in fh:
        ...
        if a is not None and pattern_found is None:
            ...
            string = string + line
            pattern_found = 1
#    print('printing line_list: ', line_list)
...
def smb_log_line_extraction(start_time, end_time):
    df5 = df.set_index(['Time'])
    return df5.loc[start_time:end_time]

smb_lines = smb_log_line_extraction('2019/10/23 20:24:26.072000','2019/10/23 20:24:26.096000')
