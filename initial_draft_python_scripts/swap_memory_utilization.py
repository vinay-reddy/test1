...
pandas_plot2 = pd.read_csv('/Users/vinayreddy/Desktop/logs/gregory-server-performance/a/PolicyManagerLogs/system-load-monitor/swap.csv', names=columns2, header=None)
